  ...
  <div class="admin-wrapper clearfix">
    ...
    <div class="admin-content clearfix">
      ...
      <div class="">
        ...
        <?php require_once('../../app/controllers/topics.php') ?>
        <form action="../../app/controllers/topics.php" method="post">
          ...
          <div class="input-group">
            ...
            <textarea class="text-input" name="description" id="description"><?= $description ?>
  </textarea>
          </div>
          <div class="input-group">
            <button type="submit" name="update" class="btn">Update Topic</button>
          </div>
        </form>
